...
const projects = [
  {
    ...
    tags: ['Cuda', 'C'],
    description: 'Developed a CUDA-based image processing application that applies various filters and transformations to images, leveraging GPU acceleration for real-time performance.',
